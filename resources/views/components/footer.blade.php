<div class="w-full container overflow:hidden xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
    <div class="flex flex-col items-center justify-center">
        <div>
            <h1 class="font-bold tracking-wider uppercase text-gray-400 text-2xl">Step Up Style</h1>
        </div>
        ...
        <div class="flex items-center mt-6">
            <p class="text-base leading-4 text-gray-800 dark:text-gray-400">2023 <span class="font-semibold">Step Up Style</span></p>
